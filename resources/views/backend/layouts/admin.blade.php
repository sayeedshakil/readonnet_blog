    ...
    <header class="app-header navbar">
        ...
        <ul class="nav navbar-nav ml-auto mr-4">
            ...
            <li class="c-header-nav-item dropdown">
                ...
                <div class="c-avatar">
                    @if(auth()->user()->image)
                        <img src="{{ asset('storage/backend/images/profileImage/' . auth()->user()->image) }}" class="rounded-circle" width="40" height="40" alt="{{auth()->user()->name}}" title="{{auth()->user()->name}} ">
                    @else
                        <img src="{{ asset('backend/images/default/default_user.png') }}" class="rounded-circle img-fluid" width="40" height="40"
              ...
              <div class="dropdown-menu dropdown-menu-right pt-0">
                ...
                <div class="dropdown-header bg-light py-2"><strong>Settings</strong>
                    ...
                    <a class="dropdown-item" href="{{route('backend.profiles.show',auth()->user()->id)}}">
                    <svg class="c-icon mr-2">
                      <use xlink:href="{{ url('backend/icons/sprites/free.svg#cil-user') }}"></use>
                    </svg> Profile</a>
                    <a class="dropdown-item" href="{{ route('backend.auth.change_password') }}">
                    <svg class="c-icon mr-2">
